...
/*
        sheet.add(".calendar_default_event:hover .calendar_default_event_delete", "background: url(data:image/png;base64,) center center no-repeat; opacity: 0.6; -ms-filter:'progid:DXImageTransform.Microsoft.Alpha(Opacity=60)'; cursor: pointer;");
        sheet.add(".calendar_default_event:hover .calendar_default_event_delete:hover", "opacity: 1;-ms-filter: none;");
*/
